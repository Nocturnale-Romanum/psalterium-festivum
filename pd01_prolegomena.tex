...
With 63 feasts in addition to the Sundays of the whole year, this book, 
together with the \emph{Invitatoriale} and the upcoming \emph{Liber Responsorialis}, 
enables the public celebration of Matins for over a hundred occasions every year, which should meet the capabilities of most parishes.
...
Avec 63 fêtes en plus des dimanches de toute l'année, ce livre, avec l'\emph{Invitatoriale} et le \emph{Liber Responsorialis} à paraître,
permet la célébration publique des Matines pour plus d'une centaine d'occasions chaque année, 
ce qui devrait correspondre aux capacités de la plupart des paroisses.
